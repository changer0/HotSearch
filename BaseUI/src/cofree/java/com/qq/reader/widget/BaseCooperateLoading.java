...
import com.qq.reader.widget.loading.BallSpinFadeLoaderIndicator;
import com.qq.reader.widget.loading.LoadingIndicator;
...
//    private static final BallSpinFadeLoaderIndicator DEFAULT_INDICATOR=new BallSpinFadeLoaderIndicator();
    ...
    public BaseCooperateLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0,R.style.LoadingIndicatorView);
    }

    public BaseCooperateLoading(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.LoadingIndicatorView);
    }

//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public BaseCooprateLoading(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor = a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, 0xb6b6b6);
        //setIndicator(indicatorName);
        if (mIndicator==null){
            setIndicator(new BallSpinFadeLoaderIndicator());
        }
        a.recycle();
    }

    public LoadingIndicator getIndicator() {
        return mIndicator;
    }

    public void setIndicator(LoadingIndicator d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
