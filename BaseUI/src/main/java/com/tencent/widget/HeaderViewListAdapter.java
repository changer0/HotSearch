 ...
 * header views and their associated data objects.
 * <p/>
...
public class HeaderViewListAdapter implements WrapperListAdapter, Filterable {
    ...
    public boolean isEnabled(int position) {
        ...
        if (position < numHeaders) {
            try {
                ...
                Log.printErrStackTrace("HeaderViewListAdapter", e, null, null);
                if (e != null) {
                    Log.d("HeaderViewListAdapter", e.toString());
                }
            }
        }
        ...
        try {
            ...
            Log.printErrStackTrace("HeaderViewListAdapter", e, null, null);
            throw new RuntimeException("adapter index out of bound. adapter count: " + adapterCount + ", footCount: " + mFooterViewInfos.size()
                    + " , position: " + adjPosition + ", Adapter: " + mAdapter);
        }
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            Log.printErrStackTrace("HeaderViewListAdapter", e, null, null);
            throw new RuntimeException("adapter index out of bound. adapter count: " + adapterCount + ", footCount: " + mFooterViewInfos.size() + " , position: " + adjPosition + ", Adapter: " + mAdapter);
        }
    }
