...
public abstract class AbsListView extends AdapterView<ListAdapter> implements
        TextWatcher, ViewTreeObserver.OnGlobalLayoutListener,
...
/* ,RemoteViewsAdapter.RemoteAdapterConnectionCallback */ {
    ...
    // /**
    // * The remote adapter containing the data to be displayed by this view to
    // be set
    // */
    ...
    /**
     * The StrictMode "critical time span" objects to catch animation stutters.
     * Non-null when a time-sensitive animation is in-flight. Must call finish()
     * on them when done animating. These are no-ops on user builds.
     */
    ...
    public AbsListView(Context context) {
        ...
        TypedArray a = context
                .obtainStyledAttributes(getStyleableValues("View"));
    ...
    public AbsListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArrayWarpper a = new TypedArrayWarpper(
                context.obtainStyledAttributes(attrs, ABSLISTVIEW, defStyle, 0));
        ...
        boolean stackFromBottom = a.getBoolean(ABSLISTVIEW_STACKFROMBOTTOM,
                false);
        setStackFromBottom(stackFromBottom);

        boolean scrollingCacheEnabled = a.getBoolean(
                ABSLISTVIEW_SCROLLINGCACHE, true);
        setScrollingCacheEnabled(scrollingCacheEnabled);

        boolean useTextFilter = a.getBoolean(ABSLISTVIEW_TEXTFILTERENABLED,
                false);
        setTextFilterEnabled(useTextFilter);

        int transcriptMode = a.getInt(ABSLISTVIEW_TRANSCRIPTMODE,
        ...
        boolean enableFastScroll = a.getBoolean(ABSLISTVIEW_FASTSCROLLENABLED,
                false);
        setFastScrollEnabled(enableFastScroll);

        boolean smoothScrollbar = a.getBoolean(ABSLISTVIEW_SMOOTHSCROLLBAR,
                true);
        setSmoothScrollbarEnabled(smoothScrollbar);

        setChoiceMode(a.getInt(ABSLISTVIEW_CHOICEMODE, CHOICE_MODE_NONE));
        setFastScrollAlwaysVisible(a.getBoolean(
                ABSLISTVIEW_FASTSCROLLALWAYSVISIBLE, false));
    ...
    private void initAbsListView() {
        ...
        // mMaximumVelocity = (int) (displayMetrics.density *
        // displayMetrics.heightPixels * 6);
        // if (SDKVersionUtils.isHoneycomb())
        // {
        ...
        // else
        {
            ...
            mTopOverflingDistance = mBottomOverflingDistance = (int) (density
                    * OVER_FLING_DISTANCE + 0.5f);
        }
        mDensityScale = getContext().getResources().getDisplayMetrics().density;

        // if (!SDKVersionUtils.isGingerBread())
        {
    ...
    public void setItemChecked(int position, boolean value) {
        ...
        // something.
        if (SDKVersionUtilsKt.isHoneycomb() && value
                ...
                if (mChoiceMode == CHOICE_MODE_MULTIPLE
                    ...
                    if (mCheckedIdStates != null && mAdapter.hasStableIds()) {
                        if (newValue) {
                            ...
                            mCheckedIdStates.delete(mAdapter
                                    .getItemId(position));
                        }
                    }
                    if (newValue) {
     ...
     * chosen.
     *
     * @param choiceMode One of {@link #CHOICE_MODE_NONE}, {@link #CHOICE_MODE_SINGLE},
    ...
    public void setFastScrollAlwaysVisible(boolean alwaysShow) {
        ...
        Method m;
        try {
            m = View.class.getDeclaredMethod("computeOpaqueFlags");
            m.setAccessible(true);
            m.invoke(this);
        } catch (Exception e) {
            Log.printErrStackTrace("AbsListView", e, null, null);
        ...
        try {
            Method m1 = View.class.getDeclaredMethod("recomputePadding");
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mSelectedPosition >= 0) {
            ...
            if (haveChildren) {
                ...
                if (v != null) {
                    ss.viewTop = mStackFromBottom ? mLayoutHeight
        ...
        // 从下向上
            ...
            if (haveChildren && mFirstPosition >= 0) {
                ...
                int lastPosition = mFirstPosition == INVALID_POSITION ? INVALID_POSITION
                ...
                // 已经滚到最后面了, 则记录为最后一行
                if (viewBottom <= mLayoutHeight - mListPadding.bottom
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (SDKVersionUtilsKt.isHoneycomb() && ss.inActionMode
                && mChoiceMode == CHOICE_MODE_MULTIPLE_MODAL
    ...
    protected int computeVerticalScrollRange() {
        ...
        if (mSmoothScrollbarEnabled) {
            ...
            // result += Math.abs((int) ((float) getScrollY() / getHeight() *
            // mItemCount * 100));
            // }
        } else {
            result = mItemCount;
    ...
    View obtainView(int position, boolean[] isScrap) {
        ...
        if (scrapView != null) {
            ...
            // ViewDebug.RecyclerTraceType.RECYCLE_FROM_SCRAP_HEAP, position,
            // -1);
            // }
            ...
            if (child != scrapView) {
                ...
                // {
                // ViewDebug.trace(scrapView,
                // ViewDebug.RecyclerTraceType.MOVE_TO_SCRAP_HEAP, position,
                // -1);
                // }
            } else {
                isScrap[0] = true;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (clipToPadding) {
            ...
            canvas.clipRect(scrollX + mPaddingLeft, scrollY + mPaddingTop,
                    scrollX + mRight - mLeft - mPaddingRight, scrollY + mBottom
                            - mTop - mPaddingBottom);
    ...
    protected int getLeftPaddingOffset() {
        return (mGroupFlags & CLIP_TO_PADDING_MASK) == CLIP_TO_PADDING_MASK ? 0
                : -getPaddingLeft();
    }
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            boolean isValidPosition = isValidPosition(motionPosition,
                    mAdapter.getCount());
            if (adapter != null && (isValidPosition || mCallbackOnUnClickItem)
                    && sameWindow()) {
                ...
                if (view != null || mCallbackOnUnClickItem) {
                    performItemClick(view, motionPosition,
                            isValidPosition ? adapter.getItemId(motionPosition)
                                    : 0);
                }
            }
        }
    ...
    boolean performLongPress(final View child, final int longPressPosition,
        ...
        if (mOnItemLongClickListener != null) {
            handled = mOnItemLongClickListener.onItemLongClick(
                    AbsListView.this, child, longPressPosition, longPressId);
        }
        if (!handled) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(
                        AbsListView.this, originalView, longPressPosition,
                        longPressId);
            }
            if (!handled) {
    ...
    private void scrollIfNeeded(int y) {
        ...
        if (mTouchMode == TOUCH_MODE_SCROLL) {
            ...
            if (y != mLastY) {
                ...
                // intercept.
                if ((mGroupFlags & 0x80000 /* FLAG_DISALLOW_INTERCEPT */) == 0
                ...
                if (motionView != null) {
                    ...
                    if (atEdge) {
                        ...
                        overScrollBy(0, reviseOverScrollByTouch(overscroll), 0,
                                getScrollY(), 0, 0, 0, mOverscrollDistance,
                                true);
            ...
            if (y != mLastY) {
                ...
                if (overScrollDistance != 0) {
                    final int scrollY = getScrollY();
                    overScrollBy(0,
                            reviseOverScrollByTouch(overScrollDistance), 0,
                            scrollY, 0, 0, 0, mOverscrollDistance, true);
                    final int overscrollMode = getOverScrollMode();
                    if (overscrollMode == OVER_SCROLL_ALWAYS
                            || (overscrollMode == OVER_SCROLL_IF_CONTENT_SCROLLS && !contentFits())) {
                        if (mEdgeGlowTop != null) {
                            if (rawDeltaY > 0) {
                                ...
                                mEdgeGlowBottom
                                        .onPull((float) overScrollDistance
                                                / getHeight());
                                if (!mEdgeGlowTop.isFinished()) {
                                    mEdgeGlowTop.onRelease();
                                }
    ...
    private int reviseOverScrollByTouch(int srcs) {
        if (srcs * mScrollY < 0) {
            ...
            int res = (mLayoutHeight - Math.abs(mScrollY)) * srcs
                    / mLayoutHeight / 2;
            return res;
        }
    }
            ...
            case MotionEvent.ACTION_UP: {
                switch (mTouchMode) {
                    ...
                    case TOUCH_MODE_SCROLL:
                        ...
                        if (childCount > 0) {
                            ...
                            if (mFirstPosition == 0 && firstChildTop >= contentTop
                                ...
                                final int initialVelocity = (int) ((SDKVersionUtilsKt
                                        .isrFroyo() ? velocityTracker
                    ...
                    case TOUCH_MODE_OVERSCROLL:
                        ...
                        // velocityTracker.computeCurrentVelocity(1000,
                        // mMaximumVelocity);
                        // final int initialVelocity = SDKVersionUtils.isrFroyo() ? (int)
                        // velocityTracker
                        // .getYVelocity(mActivePointerId) : (int)
    ...
    protected void reportScrollStateChange(int newState) {
        if (newState != mLastScrollState) {
            // 根据listview的滑动状态改变后台线程优先级
//			if (AppSetting.threadPriorityEnable) {
//				ThreadPriorityManager
//						.moniterThreadPriority(newState != OnScrollListener.SCROLL_STATE_IDLE);
//			}
    ...
    private class FlingRunnable implements Runnable {
        ...
        private final Runnable mCheckFlywheel = new Runnable() {
            ...
            public void run() {
                ...
                final float yvel = SDKVersionUtilsKt.isrFroyo() ? -vt
                        .getYVelocity(activeId) : -vt.getYVelocity();
        ...
        void startSpringback(int offset) {
            ...
            // }
            if (mScroller.springBack(0, getScrollY(), offset, offset, offset,
                    offset)) {
        ...
        void edgeReached(int delta) {
            mScroller.notifyVerticalEdgeReached(delta, 0,
                    delta > 0 ? mTopOverflingDistance
                            : mBottomOverflingDistance);
            final int overscrollMode = getOverScrollMode();
            if (overscrollMode == OVER_SCROLL_ALWAYS
                    || (overscrollMode == OVER_SCROLL_IF_CONTENT_SCROLLS && !contentFits())) {
                mTouchMode = TOUCH_MODE_OVERFLING;
    ...
    class MoveToBottomScroller implements Runnable {
        ...
        void start() {
            ...
            if (scrollCount == 0) {
                ...
                // 要滚动的距离
                mDistance = getChildAt(getChildCount() - 1).getBottom()
                        - childrenBottom;
                // 滚到底了
                if (mDistance == 0) {
                    stop();
                ...
                // 要滚动的距离(估算)
                final int scrollDistance = scrollCount * getHeight()
                        / getChildCount();
                mMaxVeloctiy = (float) scrollDistance
                        / (0.75f * SCROLL_DURATION);
                // 估算加速度
        ...
        public void run() {
            ...
            try {
                ...
                switch (mStatus) {
                    ...
                    case STATUS_ACCERLERING:
                        ...
                        if (currentTime > SCROLL_DURATION / 4) {
                            ...
                            motionY = (int) (mMaxVeloctiy * currentTime - mMaxVeloctiy
                                    * SCROLL_DURATION / 8);
                            // 转为匀速
                            mAccerleration = 0;
                    ...
                    case STATUS_DECERLERING:
                        if (currentTime > mDuration) {
                            ...
                            // v = v0 - at
                            mCurrVelocity = mCurrVelocity - mAccerleration
                                    * currentTime;
                            // s = v0^2 - 1/2at^2
                            motionY = (int) (mDistance - mCurrVelocity
                                    * (mDuration - currentTime) / 2);
                        }
                        break;
                ...
                if (!atEdge) {
                    ...
                    final int firstPosition = mFirstPosition;
                    // 目标出现了
                    if (mStatus != STATUS_VISCOUS_FLUID
                            && mStatus != STATUS_DECERLERING
                            && firstPosition + childCount - 1 >= mTargetPosition) {
                        int childrenBottom = mBottom - mTop
                                - mListPadding.bottom;
                        // 要滚动的距离
                        mDistance = getChildAt(childCount - 1).getBottom()
                                - childrenBottom;
                        // 滚到底了
                        if (mDistance == 0) {
                            stop();
                        ...
                        mStartTime = AnimationUtils
                                .currentAnimationTimeMillis();
                        lastMotionY = 0;
                        // 大于最小速度, 则开始减速
                        if (mCurrVelocity * 1000 > mMinimumVelocity
                                && !mUseViscousFluid) {
                            mStatus = STATUS_DECERLERING;
    ...
    class PositionScroller implements Runnable {
        ...
        void startWithOffset(int position, int offset, int duration) {
            ...
            final float screenTravelCount = (float) viewTravelCount
                    / childCount;
            // mScrollDuration = screenTravelCount < 1 ? (int)
            // (screenTravelCount * duration)
            ...
            switch (mMode) {
                ...
                case MOVE_OFFSET: {
                    ...
                    if (position < firstPos) {
                        ...
                        final int duration = Math
                                .abs((int) (mScrollDuration * ((float) distance / getHeight())));
     ...
     * @param offset   Desired distance in pixels of <code>position</code> from the
            ...
            if (mNeedSync) {
                ...
                switch (mSyncMode) {
                    ...
                    case SYNC_LAST_POSITION:
                        ...
                        // mSyncPosition = Math.min(Math.max(0, mSyncPosition),
                        // count - 1);
                        mSyncPosition = Math.max(
                                Math.min(mSyncPosition, count - 1), 0);
    ...
    private void positionPopup() {
        ...
        final int bottomGap = screenHeight - xy[1] - getHeight()
                + (int) (mDensityScale * 20);
        if (!mPopup.isShowing()) {
            mPopup.showAtLocation(this, Gravity.BOTTOM
                    | Gravity.CENTER_HORIZONTAL, xy[0], bottomGap);
        } else {
    ...
    boolean sendToTextFilter(int keyCode, int count, KeyEvent event) {
        ...
        if (okToSend) {
            ...
            if (forwardEvent.getRepeatCount() > 0) {
                forwardEvent = KeyEvent.changeTimeRepeat(event,
...
//		}
    ...
    protected boolean onConsistencyCheck(int consistency) {
        ...
        final boolean checkLayout = (consistency & 0x1/*
													 * ViewDebug.CONSISTENCY_LAYOUT
													 */) != 0;
    ...
    // // Ensure that we don't already have a RemoteViewsAdapter that is bound
    // to an existing
    ...
    class RecycleBin {
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    final AbsListView.LayoutParams lp = (AbsListView.LayoutParams) victim
                            .getLayoutParams();
    ...
    private Object enterCriticalSpan(String name) {
        if (DEBUG) {
            try {
                if (SDKVersionUtilsKt.isGingerBread()) {
                    Method m = StrictMode.class.getMethod("enterCriticalSpan",
                            String.class);
    ...
    protected boolean performButtonActionOnTouchDown(MotionEvent event) {
        if (SDKVersionUtilsKt.isIceScreamSandwich()
    ...
    private void dispatchStartTemporaryDetachForView(View v) {
        try {
            // 尝试调用 v.dispatchStartTemporaryDetach
            Method method = View.class
                    .getMethod("dispatchStartTemporaryDetach");
            method.invoke(v);
        } catch (Exception e) {
            Log.printErrStackTrace("AbsListView", e, null, null);
    ...
    private void dispatchFinishTemporaryDetachForView(View v) {
        try {
            // 尝试调用 v.dispatchStartTemporaryDetach
            Method method = View.class
                    .getMethod("dispatchFinishTemporaryDetach");
            method.invoke(v);
        } catch (Exception e) {
            Log.printErrStackTrace("AbsListView", e, null, null);
     ...
     * @param maxOverScrollX Number of pixels to overscroll by in either direction along
     *                       the X axis.
     * @param maxOverScrollY Number of pixels to overscroll by in either direction along
     *                       the Y axis.
    ...
    /**
     * 设置最大fling的速度..默认值跟机器有关.. 一般为8000dp
     *
     * @param mMaximumVelocity
     */
    public void setMaximumVelocity(int mMaximumVelocity) {
